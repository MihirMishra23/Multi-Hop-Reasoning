"""Standalone Search-R1 eval — same questions / metric as the LMLM eval, no
...
log = logging.getLogger("eval_search_r1")
...
def main():
    ...
    p.add_argument("--split", default="dev",
                   choices=["dev", "train_val1k", "train_train1k"])
    ...
    p.add_argument("--max_tool_response_length", type=int, default=512,
